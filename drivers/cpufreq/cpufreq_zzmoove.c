 ...
 *            (C)  2017 Jason Edson <jaysonedson@gmail.com>
 *
...
#define ZZMOOVE_VERSION "bLE-benzo"
...
#define DEF_SCALING_PROPORTIONAL		(2)	// ZZ: default for proportional scaling, disabled here
#define DEF_FAST_SCALING_UP			(5)	// Yank: default fast scaling for upscaling
#define DEF_FAST_SCALING_DOWN			(5)	// Yank: default fast scaling for downscaling
